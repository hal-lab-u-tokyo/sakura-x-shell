...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net pll_clk_out1 [get_bd_pins pll/clk_out1] [get_bd_pins axi_led/s_axi_aclk] [get_bd_pins controler_AXI_0_axi_periph/M00_ACLK] [get_bd_pins rst_pll_100M/slowest_sync_clk] [get_bd_pins controler_AXI_0_axi_periph/ACLK] [get_bd_pins controler_AXI_0_axi_periph/M01_ACLK]
  connect_bd_net -net rst_pll_100M_peripheral_aresetn [get_bd_pins rst_pll_100M/peripheral_aresetn] [get_bd_pins axi_led/s_axi_aresetn] [get_bd_pins controler_AXI_0_axi_periph/M00_ARESETN] [get_bd_pins controler_AXI_0_axi_periph/ARESETN] [get_bd_pins controler_AXI_0_axi_periph/M01_ARESETN]
