####################################################################################
# Generated from file : 'pin_sasebo_giii_k7_orig_rev1_2.ucf'
####################################################################################

#================================================�@Timing constraint
# k_clk_osc_p<0>, k_clk_osc_n<0> : 200.000MHz
# create_clock -period 5.000 -name k_clk_osc_p[0] -waveform {0.000 2.500} [get_ports k_clk_osc_p[0]]

# k_clk_osc_p<1>, k_clk_osc_n<1> : 200.000MHz
# create_clock -period 5.000 -name k_clk_osc_p[0] -waveform {0.000 2.500} [get_ports k_clk_osc_p[1]]
...
# CLOCK / RESET #
#################
# set_property PACKAGE_PIN AB2 [get_ports k_clk_osc_p[0]]
# set_property IOSTANDARD DIFF_HSTL_I [get_ports k_clk_osc_p[0]]
# set_property PACKAGE_PIN AC2 [get_ports k_clk_osc_n[0]]
# set_property IOSTANDARD DIFF_HSTL_I [get_ports k_clk_osc_n[0]]

# set_property PACKAGE_PIN AA3 [get_ports k_clk_osc_p[1]]
# set_property IOSTANDARD DIFF_HSTL_I [get_ports k_clk_osc_p[1]]
# set_property PACKAGE_PIN AA2 [get_ports k_clk_osc_n[1]]
# set_property IOSTANDARD DIFF_HSTL_I [get_ports k_clk_osc_n[1]]

# IO_0_16
# set_property PACKAGE_PIN J8 [get_ports k_clk_osc_inh_b]
# set_property IOSTANDARD LVCMOS25 [get_ports k_clk_osc_inh_b]
...
#######
# IO_L18N_T2_A23_15
# set_property PACKAGE_PIN G20 [get_ports {k_led[0]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {k_led[0]}]
# IO_L21P_T3_DQS_15
# set_property PACKAGE_PIN L19 [get_ports {k_led[1]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {k_led[1]}]
# IO_L24N_T3_RS0_15
# set_property PACKAGE_PIN K18 [get_ports {k_led[2]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {k_led[2]}]
# IO_L18P_T2_A24_15
# set_property PACKAGE_PIN H19 [get_ports {k_led[3]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {k_led[3]}]
# IO_0_15
# set_property PACKAGE_PIN K15 [get_ports {k_led[4]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {k_led[4]}]
# IO_L20P_T3_13
# set_property PACKAGE_PIN P16 [get_ports {k_led[5]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {k_led[5]}]
# IO_L19N_T3_VREF_13
# set_property PACKAGE_PIN T19 [get_ports {k_led[6]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {k_led[6]}]
# IO_L19P_T3_13
# set_property PACKAGE_PIN T18 [get_ports {k_led[7]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {k_led[7]}]
# IO_L6P_T0_16
# set_property PACKAGE_PIN H12 [get_ports {k_led[8]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {k_led[8]}]
# IO_L6N_T0_VREF_16
# set_property PACKAGE_PIN H11 [get_ports {k_led[9]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {k_led[9]}]
...
# IO_L13P_T2_MRCC_33
# set_property PACKAGE_PIN AB11 [get_ports ks_hpic_clk_p]
# set_property IOSTANDARD DIFF_HSTL_I_DCI [get_ports ks_hpic_clk_p]

# IO_L6N_T0_VREF_34
# set_property PACKAGE_PIN W4 [get_ports {ks_hpic_n[0]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[0]}]
# IO_L6P_T0_34
# set_property PACKAGE_PIN V4 [get_ports {ks_hpic_p[0]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[0]}]
# IO_L8N_T1_34
# set_property PACKAGE_PIN V1 [get_ports {ks_hpic_n[1]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[1]}]
# IO_L8P_T1_34
# set_property PACKAGE_PIN V2 [get_ports {ks_hpic_p[1]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[1]}]
# IO_L10N_T1_34
# set_property PACKAGE_PIN Y1 [get_ports {ks_hpic_n[2]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[2]}]
# IO_L10P_T1_34
# set_property PACKAGE_PIN W1 [get_ports {ks_hpic_p[2]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[2]}]
# IO_L9N_T1_DQS_34
# set_property PACKAGE_PIN AC1 [get_ports {ks_hpic_n[3]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[3]}]
# IO_L9P_T1_DQS_34
# set_property PACKAGE_PIN AB1 [get_ports {ks_hpic_p[3]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[3]}]
# IO_L7N_T1_34
# set_property PACKAGE_PIN Y2 [get_ports {ks_hpic_n[4]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[4]}]
# IO_L7P_T1_34
# set_property PACKAGE_PIN Y3 [get_ports {ks_hpic_p[4]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[4]}]
# IO_L5N_T0_34
# set_property PACKAGE_PIN V6 [get_ports {ks_hpic_n[5]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[5]}]
# IO_L5P_T0_34
# set_property PACKAGE_PIN U7 [get_ports {ks_hpic_p[5]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[5]}]
# IO_L4N_T0_34
# set_property PACKAGE_PIN W3 [get_ports {ks_hpic_n[6]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[6]}]
# IO_L4P_T0_34
# set_property PACKAGE_PIN V3 [get_ports {ks_hpic_p[6]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[6]}]
# IO_L24N_T3_33
# set_property PACKAGE_PIN AF9 [get_ports {ks_hpic_n[7]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[7]}]
# IO_L24P_T3_33
# set_property PACKAGE_PIN AF10 [get_ports {ks_hpic_p[7]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[7]}]
# IO_L17N_T2_33
# set_property PACKAGE_PIN AD13 [get_ports {ks_hpic_n[8]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[8]}]
# IO_L17P_T2_33
# set_property PACKAGE_PIN AC13 [get_ports {ks_hpic_p[8]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[8]}]
# IO_L21N_T3_DQS_33
# set_property PACKAGE_PIN AF12 [get_ports {ks_hpic_n[9]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[9]}]
# IO_L21P_T3_DQS_33
# set_property PACKAGE_PIN AE12 [get_ports {ks_hpic_p[9]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[9]}]
# IO_L1N_T0_34
# set_property PACKAGE_PIN U5 [get_ports {ks_hpic_n[10]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[10]}]
# IO_L1P_T0_34
# set_property PACKAGE_PIN U6 [get_ports {ks_hpic_p[10]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[10]}]
# IO_L23N_T3_33
# set_property PACKAGE_PIN AF13 [get_ports {ks_hpic_n[11]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[11]}]
# IO_L23P_T3_33
# set_property PACKAGE_PIN AE13 [get_ports {ks_hpic_p[11]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[11]}]
# IO_L14N_T2_SRCC_33
# set_property PACKAGE_PIN AB10 [get_ports {ks_hpic_n[12]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[12]}]
# IO_L14P_T2_SRCC_33
# set_property PACKAGE_PIN AA10 [get_ports {ks_hpic_p[12]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[12]}]
# IO_L15N_T2_DQS_33
# set_property PACKAGE_PIN AC12 [get_ports {ks_hpic_n[13]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[13]}]
# IO_L15P_T2_DQS_33
# set_property PACKAGE_PIN AB12 [get_ports {ks_hpic_p[13]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[13]}]
# IO_L13N_T2_MRCC_34
# set_property PACKAGE_PIN AB4 [get_ports {ks_hpic_n[14]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[14]}]
# IO_L13P_T2_MRCC_34
# set_property PACKAGE_PIN AA4 [get_ports {ks_hpic_p[14]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[14]}]
# IO_L22N_T3_33
# set_property PACKAGE_PIN AF8 [get_ports {ks_hpic_n[15]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[15]}]
# IO_L22P_T3_33
# set_property PACKAGE_PIN AE8 [get_ports {ks_hpic_p[15]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[15]}]
# IO_L20N_T3_33
# set_property PACKAGE_PIN AE10 [get_ports {ks_hpic_n[16]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[16]}]
# IO_L20P_T3_33
# set_property PACKAGE_PIN AD10 [get_ports {ks_hpic_p[16]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[16]}]
# IO_L18N_T2_33
# set_property PACKAGE_PIN Y12 [get_ports {ks_hpic_n[17]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[17]}]
# IO_L18P_T2_33
# set_property PACKAGE_PIN Y13 [get_ports {ks_hpic_p[17]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_p[17]}]
# IO_L16N_T2_33
# set_property PACKAGE_PIN AA12 [get_ports {ks_hpic_n[18]}]
# set_property IOSTANDARD LVCMOS15 [get_ports {ks_hpic_n[18]}]
# IO_L16P_T2_33
...
########################################
# IO_L17N_T2_13
# set_property PACKAGE_PIN T23 [get_ports {ks_hric_n[0]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[0]}]
# IO_L17P_T2_13
# set_property PACKAGE_PIN T22 [get_ports {ks_hric_p[0]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[0]}]
# IO_L8N_T1_13
# set_property PACKAGE_PIN L24 [get_ports {ks_hric_n[1]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[1]}]
# IO_L8P_T1_13
# set_property PACKAGE_PIN M24 [get_ports {ks_hric_p[1]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[1]}]
# IO_L1N_T0_13
# set_property PACKAGE_PIN K26 [get_ports {ks_hric_n[2]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[2]}]
# IO_L1P_T0_13
# set_property PACKAGE_PIN K25 [get_ports {ks_hric_p[2]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[2]}]
# IO_L2N_T0_13
# set_property PACKAGE_PIN P26 [get_ports {ks_hric_n[3]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[3]}]
# IO_L2P_T0_13
# set_property PACKAGE_PIN R26 [get_ports {ks_hric_p[3]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[3]}]
# IO_L3N_T0_DQS_13
# set_property PACKAGE_PIN L25 [get_ports {ks_hric_n[4]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[4]}]
# IO_L3P_T0_DQS_13
# set_property PACKAGE_PIN M25 [get_ports {ks_hric_p[4]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[4]}]
# IO_L23N_T3_13
# set_property PACKAGE_PIN T17 [get_ports {ks_hric_n[5]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[5]}]
# IO_L23P_T3_13
# set_property PACKAGE_PIN U17 [get_ports {ks_hric_p[5]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[5]}]
# IO_L5N_T0_13
# set_property PACKAGE_PIN M26 [get_ports {ks_hric_n[6]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[6]}]
# IO_L5P_T0_13
# set_property PACKAGE_PIN N26 [get_ports {ks_hric_p[6]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[6]}]
# IO_L21N_T3_DQS_13
# set_property PACKAGE_PIN R17 [get_ports {ks_hric_n[7]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[7]}]
# IO_L21P_T3_DQS_13
# set_property PACKAGE_PIN R16 [get_ports {ks_hric_p[7]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[7]}]
# IO_L16N_T2_13
# set_property PACKAGE_PIN R20 [get_ports {ks_hric_n[8]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[8]}]
# IO_L16P_T2_13
# set_property PACKAGE_PIN T20 [get_ports {ks_hric_p[8]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[8]}]
# IO_L14N_T2_SRCC_13
# set_property PACKAGE_PIN R23 [get_ports {ks_hric_n[9]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[9]}]
# IO_L14P_T2_SRCC_13
# set_property PACKAGE_PIN R22 [get_ports {ks_hric_p[9]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[9]}]
# IO_L10N_T1_13
# set_property PACKAGE_PIN M22 [get_ports {ks_hric_n[10]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[10]}]
# IO_L10P_T1_13
# set_property PACKAGE_PIN M21 [get_ports {ks_hric_p[10]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[10]}]
# IO_L15N_T2_DQS_13
# set_property PACKAGE_PIN T25 [get_ports {ks_hric_n[11]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[11]}]
# IO_L15P_T2_DQS_13
# set_property PACKAGE_PIN T24 [get_ports {ks_hric_p[11]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[11]}]
# IO_L11N_T1_SRCC_13
# set_property PACKAGE_PIN N23 [get_ports {ks_hric_n[12]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[12]}]
# IO_L11P_T1_SRCC_13
# set_property PACKAGE_PIN P23 [get_ports {ks_hric_p[12]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[12]}]
# IO_L12N_T1_MRCC_13
# set_property PACKAGE_PIN N22 [get_ports {ks_hric_n[13]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[13]}]
# IO_L12P_T1_MRCC_13
# set_property PACKAGE_PIN N21 [get_ports {ks_hric_p[13]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[13]}]
# IO_L13N_T2_MRCC_13
# set_property PACKAGE_PIN P21 [get_ports {ks_hric_n[14]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[14]}]
# IO_L13P_T2_MRCC_13
# set_property PACKAGE_PIN R21 [get_ports {ks_hric_p[14]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[14]}]
# IO_L22N_T3_13
# set_property PACKAGE_PIN M19 [get_ports {ks_hric_n[15]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[15]}]
# IO_L22P_T3_13
# set_property PACKAGE_PIN N18 [get_ports {ks_hric_p[15]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[15]}]
# IO_L24N_T3_13
# set_property PACKAGE_PIN P18 [get_ports {ks_hric_n[16]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[16]}]
# IO_L24P_T3_13
# set_property PACKAGE_PIN R18 [get_ports {ks_hric_p[16]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_p[16]}]
# IO_L18N_T2_13
# set_property PACKAGE_PIN U20 [get_ports {ks_hric_n[17]}]
# set_property IOSTANDARD LVCMOS25 [get_ports {ks_hric_n[17]}]
# IO_L18P_T2_13
...
##############
# DDR3 SDRAM #
# Highly recommended to use the Memory Interface Generator (MIG) enabled template
##############
# IO_L11P_T1_SRCC_33
