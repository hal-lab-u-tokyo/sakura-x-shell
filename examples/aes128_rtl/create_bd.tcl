...
# check IP
set aes_rtl_core_ip "tkojima.me:user:aes_rtl_core:1.0"

set ip_repo_loc [file normalize [file join $scriptDir "../../vivado/ip_repo"]]
set src_set [current_fileset -quiet]
set current_ip_repo_paths [get_property "ip_repo_paths" $src_set]
# append
set aes_rtl_core_ip_repo "[file join $ip_repo_loc "aes_rtl_core_1_0" ]"
...
connect_bd_intf_net -intf_net controler_AXI_0_axi_periph_M01_AXI [get_bd_intf_pins controler_AXI_0_axi_periph/M01_AXI] [get_bd_intf_pins aes_rtl_core_0/S00_AXI]
